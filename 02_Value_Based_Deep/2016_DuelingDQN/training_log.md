...
| 測試狀態 | V(s) | A(←) | A(→) | Q(←) | Q(→) | 選擇動作 |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| 正中央靜止（初始） | 247.351 | -6.568 | -10.378 | 249.257 | 245.446 | ←（推左） |
| 桿往左傾（需推左） | 234.826 | -5.366 | -10.554 | 237.420 | 232.232 | ←（推左） |
| 桿往右傾（需推右） | 254.880 | -7.747 | -8.277 | 255.145 | 254.615 | ←（推左） |
| 小車往左移（需推右） | 221.747 | -6.190 | -9.059 | 223.181 | 220.312 | ←（推左） |
